...
import { Cliente, Encuesta, Pedido, UserDetails } from 'src/app/interfaces/app.interface';
...
export class EncuestaAltaPage implements OnInit {
  ...
  aniadirEncuesta() : void
  {
    ...
    ))
    {
      ...
      if(this.isOtro || this.isPublicidad || this.isRecomendacion || this.isRedes)
      {
        ...
        this.spinner.hide();
        this.showAlert('Encuesta añadida', 'Encuesta añadida a la base de datos con éxito!','cliente-estado-pedido-encuesta');
      }
      else{
        this.showAlert('Error','Datos incompletos, porfavor complete el formulario')
      }
